            ...
            <Box mb={2} mt={3} display="flex" width="84%" justifyContent="space-between" flexWrap="wrap">
              <Box display="flex" gap={2} flexWrap="wrap" mb={{ xs: '20px', sm: 0 }}>
                ...
                >
                  ...
                  {['Condominiums', 'Single-detached houses','Commercial building','Industrial building','Land ','Vacation homes','Retirement homes','Mixed-use developments', 'Apartment', 'Villa', 'Farmhouse', 'Condos', 'Townhouse', 'Duplex', 'Studio', 'Chalet'].map((type) => (
